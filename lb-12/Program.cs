...
namespace Lab_OOP_13
{
    ...
    public class KRVFileManager
    {
        public void FileManager(string path)
        {
            Console.WriteLine("\nFileManager:");
            string filepath = path + "\\OOP\\" + "KRVInspect";
            Directory.CreateDirectory(filepath);

            string filename = filepath + "\\" + "krvdirinfo.txt";
            ...
            file.CopyTo(filepath + "\\" + "newKRVDirInfo.txt", true);
            file.Delete();
            ...
            string filecopydir = path + "\\OOP\\" + "KRVFiles";
            ...
            directory.MoveTo("D:\\OOP\\KRVInspect\\KRVFiles");
            Console.WriteLine("KRVFiles moved to KRVInspect.");

            //c.Сделайте архив из файлов директория XXXFiles.
            //Разархивируйте его в другой директорий.
            ZipFile.CreateFromDirectory("D:\\OOP\\KRVInspect\\KRVFiles", "D:\\OOP\\arch.zip");
    ...
    class Program
    {
        ...
        public static void KRVLog()
        {
            FileSystemWatcher watcher = new FileSystemWatcher();
            watcher.Path = "D:\\OOP\\";
            watcher.NotifyFilter = NotifyFilters.LastAccess | NotifyFilters.LastWrite//(Перечисление)Задает изменения, наблюдаемые в файле или папке.
            ...
            KRVDiskInfo diskInfo = new KRVDiskInfo();
            diskInfo.DiskInfo();

            KRVFileInfo fileInfo = new KRVFileInfo();
            fileInfo.FileData("D:\\OOP\\krvlogfile.txt");

            KRVDirInfo dirInfo = new KRVDirInfo();
            dirInfo.DirInfo("D:\\OOP");

            KRVFileManager fileManager = new KRVFileManager();
            fileManager.FileManager("D:");
        }

        private static void OnChanged(object source, FileSystemEventArgs e)
        {
            StreamWriter writer = new System.IO.StreamWriter("D:\\OOP\\krvlogfile.txt", true);
