    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Collection<Game> game_list = new Collection<Game>("Список игр:"); //Предоставляет базовый класс для универсальной коллекции.
            ...
            ObservableCollection<Game> observableGames = new ObservableCollection<Game>()//Представляет динамическую коллекцию данных, которая предоставляет уведомления при добавлении или удалении элементов или обновлении всего списка.
            {
